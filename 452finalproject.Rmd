...
```{r}
lm(score ~ part_dance + part_athletics + part_club + part_music + part_art, data = testDF) %>% summary

```

```{r}
lm(score ~ part_dance + part_athletics + part_club + part_music + part_art + 
           family_income + mom_work_status + both_parents + mom_educ + problem_crime, data = testDF) %>% summary
